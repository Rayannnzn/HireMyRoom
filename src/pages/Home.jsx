...
const categories = [
  { label: 'Normal Rooms', value: 'normal' },
  { label: 'Luxury Rooms', value: 'luxury' },
  { label: 'VIP Rooms', value: 'vip' },
  { label: 'VVIP Rooms', value: 'vvip' },
  { label: 'Married Couple Rooms', value: 'vip' },
];
